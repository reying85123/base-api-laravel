...
return [
    ...
    */
    ...
    'enum'                 => ':attribute 不是有效值',
    'enum_key'             => ':attribute 不是有效值',
    'enum_value'           => ':attribute 不是有效值',
    'gte'                  => [
        'numeric' => ':attribute 必須大於等於 :value',
        'file'    => ':attribute 必須大於等於 :value kb',
        'string'  => ':attribute 必須有大於等於 :value 個字元',
        'array'   => ':attribute 必須包含大於等於 :value 個',
    ],
    'gt'                  => [
        'numeric' => ':attribute 必須大於 :value',
        'file'    => ':attribute 必須大於 :value kb',
        'string'  => ':attribute 必須有大於 :value 個字元',
        'array'   => ':attribute 必須包含大於 :value 個',
    ],
    'lte'                 => [
        'numeric' => ':attribute 必須小於等於 :value',
        'file'    => ':attribute 必須小於等於 :value kb',
        'string'  => ':attribute 必須有小於等於 :value 個字元',
        'array'   => ':attribute 必須包含小於等於 :value 個',
    ],
    'lt'                  => [
        'numeric' => ':attribute 必須小於 :value',
        'file'    => ':attribute 必須小於 :value kb',
        'string'  => ':attribute 必須有小於 :value 個字元',
        'array'   => ':attribute 必須包含小於 :value 個',
    ],
